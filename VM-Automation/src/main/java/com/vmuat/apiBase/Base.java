...
import com.vmuat.apiDesign.Browser;
import com.vmuat.apiDesign.Element;
import com.vmuat.manager.ConfigurationManager;
import com.vmuat.manager.WebDriverManager;
import com.vmuat.report.ExtentReport;

public class Base extends ExtentReport implements Browser, Element{
	...
	public void click(WebElement ele) {
		...
		try {
			...
			text = ele.getText();
			ele.click();
			reportStep("The Element with "+text+" clicked", "pass"); 
